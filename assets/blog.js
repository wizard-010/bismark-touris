...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // ========== BLOG POSTS DATABASE (All 24 posts) ==========
    const allPosts = [
            { title: "Madang Betelnut Ban: The Hidden Impact on Tourism & Business", url: "blog-posts/madang-betelnut-ban-impact.html", date: "April 1, 2026", readTime: "9 min read", excerpt: "Madang's betelnut ban was meant to create cleaner streets, but a decade later, the prohibition has spawned an underground black market. This in-depth analysis explores how criminal elements have infiltrated the trade, creating safety concerns for tourists and driving legitimate vendors into poverty—ultimately harming the very tourism industry the ban was meant to protect.", category: "Travel Tips", tags: ["Madang", "Betelnut", "Tourism Impact", "Policy Analysis", "Black Market", "PNG Economy"], featured: false, dateSort: "2026-04-01" },
